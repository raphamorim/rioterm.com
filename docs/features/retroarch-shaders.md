...
- **macOS / Linux** — the default builds use the native Metal / Vulkan backends, which do not include the librashader filter chain. To use filters, build with the feature enabled and select the `Webgpu` renderer in your config:
